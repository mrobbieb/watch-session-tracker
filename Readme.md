...
```
I did add an integration test `test_multiple_concurrent_viewers_are_counted` which would require the queue to be running e.g. `flosports-worker1`. `docker-compose ps` to verify.
